...
public class AdminLlmChannelService implements IAdminLlmChannelService {
    ...
    private LlmChannelVO toVo(Long id, LlmChannelRequestDTO dto) {
        return LlmChannelVO.builder()
                ...
                .channelGroup(dto.getChannelGroup())
                .status(dto.getStatus()).timeoutMs(dto.getTimeoutMs())
                .maxBodyBytes(dto.getMaxBodyBytes())
                .maxConcurrency(dto.getMaxConcurrency())
                .contextLimitTokens(dto.getContextLimitTokens())
    ...
    private LlmChannelResponseDTO toDto(LlmChannelVO vo) {
        return LlmChannelResponseDTO.builder()
                ...
                .timeoutMs(vo.getTimeoutMs()).maxBodyBytes(vo.getMaxBodyBytes())
                .maxConcurrency(vo.getMaxConcurrency()).contextLimitTokens(vo.getContextLimitTokens())
                .testTime(format(vo.getTestTime()))
